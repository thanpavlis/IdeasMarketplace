        ...
        <head>
            ...
            <script>
                function deleteClient() {
                    $.post("user_delete.php", {id: <?= $_GET['id'] ?>})
                            .done(function (data) {
                                alert('ΕΠΙΤΥΧΗΣ ΔΙΑΓΡΑΦΗ ΤΟΥ ΧΡΗΣΤΗ!');
                ...
                function updateClient() {
                    ...
                    $.post("user_update.php", {id: <?= $_GET['id'] ?>, name: $("#name").val(), lname: $("#lname").val(), email: $("#email").val(), pass: $("#pass").val(), sex: $('input[name=sex]:checked', '#client').val(), age: $("#age").val(), owner: owner})
                            .done(function (data) {
        ...
        <body>
            ...
            <div class="container" style="width: 800px;">
                <div class="row">
                    <div class="box">
                        <center>
                            <h3>Επεξεργασία στοιχείων χρήστη - <?php echo '<b>' . $first . ' ' . $last . '</b>' ?> </h3><a href="index.php">Επιστροφή στη διαχείριση χρηστών</a>  
                        </center>
                        <form id="client" onsubmit="return false">
                            ...
                            <button onclick="deleteClient();
                                        return false;" class="btn btn-danger">Διαγραφή χρήστη</button> 
                        </form>
                    </div>
                </div>
            </div> 
